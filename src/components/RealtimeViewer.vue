...
// Fetch data function using Ky via mobilityClient
...
<template>
  <div class="relative w-full h-full">
    ...
    <div class="absolute top-4 right-4 z-10 flex flex-col gap-2">
      ...
      <div
        v-if="error"
        class="bg-red-500 text-white px-3 py-1 rounded shadow text-sm"
      >
        {{ error }}
      </div>
      <div
        v-if="geojsonData"
        class="bg-white px-3 py-1 rounded shadow text-sm"
      >
    ...
    >
      <div class="font-bold mb-2 border-b pb-1">
        {{ currentStyle.legend.title }}
      </div>
      <div
