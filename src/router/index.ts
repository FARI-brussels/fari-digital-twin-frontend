...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/doc', name: 'API Documentation', component: ApiDocView },
  {
    ...
    children: [
      { path: 'assets', name: 'AssetLibrary', component: AssetLibrary },
      { path: 'maps', name: 'MapLibrary', component: MapLibrary },
      { path: 'tilesets', name: 'TilesetLibrary', component: TilesetLibrary },
      { path: 'demo', name: 'Demo', component: DemoView },
      { path: '', redirect: { name: 'AssetLibrary' } },
    ],
  },
]
